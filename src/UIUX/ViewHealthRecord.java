...
public class ViewHealthRecord extends javax.swing.JFrame {
    ...
    public ViewHealthRecord() {
        ...
        ArrayList<VitalSign> vitalSigns = healthRecord.getVitalSigns();
        ArrayList<MedicalHistory> medicalHistories = healthRecord.getMedicalHistories();
        ArrayList<BloodTest> bloodTests = healthRecord.getBloodTests();
        ArrayList<UrineTest> urineTests = healthRecord.getUrineTests();
        ArrayList<MedicalInformation> medicalInformations = healthRecord.getMedicalInformations();
                ...
                .addGroup(MedicalInfoPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(MedicalInfoPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(MedicalInfoPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(TreatmentGoalTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 543, Short.MAX_VALUE))))
                .addContainerGap())
        );
